      ...
      <div className="page-container">
        ...
        <div className="form-group">
          ...
          <p className="field-description">
            This field demonstrates pattern validation using a regex pattern for email format,
            and required field validation using React Hook Form's built-in validators.
          </p>
        </div>
        ...
        <div className="form-group">
          ...
          <p className="field-description">
            This field shows how to implement minimum length validation (8 characters)
            using React Hook Form's minLength validator.
          </p>
        </div>
        ...
        <div className="form-group">
          ...
          <p className="field-description">
            This field demonstrates custom validation using the validate function
            and real-time form watching with the watch() hook to match passwords.
          </p>
        </div>
      ...
      <div className="form-container">
        ...
        <form onSubmit={handleSubmitProfile(onSubmitProfile)}>
          ...
          <div className="form-group">
            ...
            <p className="field-description">
              This field demonstrates async validation by simulating an API call to check username availability.
          ...
          <div className="form-group">
            ...
            <p className="field-description">
              This field shows multiple numeric validations: minimum age, maximum age,
              and custom validation to ensure the value is a whole number.
            </p>
          </div>
          ...
          <div className="form-group">
            ...
            <p className="field-description">
              This field demonstrates URL pattern validation. The field is optional,
          ...
          <div className="form-group">
            ...
            <p className="field-description">
              This field shows complex pattern validation for phone numbers and custom validation
              for area codes. The field is optional but must match the format if provided.
            </p>
          </div>
