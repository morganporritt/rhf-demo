...
function ProfileForm() {
  ...
  const {
    ...
    formState: { errors: controlledErrors },
    reset: resetControlled,
    control
  } = useForm({
    defaultValues: {
      firstName: 'John',
    ...
    <>
      ...
      <div className="page-container" style={{ marginTop: '32px' }}>
        <div className="form-container">
          ...
          <form onSubmit={handleSubmitControlled(onSubmitControlled)}>
            <div className="form-group">
              <label>Title:</label>
              <Controller
                name="title"
            ...
            <div className="form-group">
              ...
              />
              {controlledErrors.firstName && (
                <span className="error">{controlledErrors.firstName.message}</span>
              )}
              <p className="field-description">
            ...
            <div className="form-group">
              ...
              />
              {controlledErrors.lastName && (
                <span className="error">{controlledErrors.lastName.message}</span>
              )}
              <p className="field-description">
